        ...
        <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-background to-accent/20 p-4">
            <div className="w-full max-w-md">
                ...
                <div className="mb-8 text-center">
                    ...
                    <h1 className="text-3xl font-bold tracking-tight">Bienvenido a HoopMetrics</h1>
                    <p className="mt-2 text-muted-foreground">Inicia sesión para acceder a tu panel</p>
                </div>
                ...
                <div className="mt-8 text-center text-xs text-muted-foreground">
                    <p>&copy; {new Date().getFullYear()} HoopMetrics. Todos los derechos reservados.</p>
                </div>
            </div>
        </div>
    );
